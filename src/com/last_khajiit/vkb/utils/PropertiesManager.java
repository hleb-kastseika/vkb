...
public final class PropertiesManager{	
	...
	static{
		/*
		 * As I developed this project on Windows OS I hardcoded filepath separator here and in some other places,
		 * so for building it on linux of some other systems we need to modify these values 
		 * (or rewrite file reading with File.separator or system properties)
		 */		
	...
	public String getProp(String key, String defaultValue){
		if(props.getProperty(key).isEmpty()) return defaultValue;
	    return props.getProperty(key);
	}
}