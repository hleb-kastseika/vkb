...
public class DupDetector {
    ...
    private static DB db = DBMaker
            .fileDB(new File(
                    propertyManager.getProp(Properties.POSTED_DB_NAME, propertyManager.DEFAULT_POSTED_DB_NAME)))
            .closeOnJvmShutdown().make();
    private static Set<String> postedIds = db
            .createHashSet(propertyManager.getProp(Properties.POSTED_SET_NAME, propertyManager.DEFAULT_POSTED_SET_NAME))
            .makeOrGet();
